...
export class ListBlogComponent implements OnInit, OnDestroy {
   ...
   filteredNotifications: any[] = [];
    ...
    ngOnInit(): void {
        this.blogService.getblog().subscribe((data) => {
            ...
            console.log("les blog sont:" +this.usersPro)
        });
       ...
       /* this.filterBlogs();*/
        ...
        this.blogService.getBlogCtaegLire().subscribe((data) => {
            ...
            console.log("les blog de categorie lire" +this.ActifCount)
        });
 ...
 /*   filterBlogs(): void {
    ...
    onTabChange3(event: any) {
        ...
        } else if (tabLabel === 'Ecouter') {
            this.showEnAttenteTab = true;
            this.showActifTab = false;
            this.showRefuseTab = false;
        } else if (tabLabel === 'Regarders') {
    ...
    getUsersByScategorie(cat: string): number {
        return this.usersPro.filter((user) => user.categories === cat).length;
    }

   /* getUsersByScategorie(cat: string): number {
        return this.usersPro.filter((user) => user.categories.includes(cat)).length;
    }*/
