...
import { BoardAdminComponent } from './components/pages/profile/board-admin/board-admin.component';
...
const routes: Routes = [
    ...
    { path: 'admin', component: TimelineComponent },
    { path: 'admintest', component: BoardAdminComponent },
    ...
    //{ path: 'editnumurgance', component: EditNumUrgencComponent },
